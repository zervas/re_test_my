...
class FibonacciAction {
 protected:
    ros::NodeHandle nh_;
    actionlib::SimpleActionServer<remy::FibonacciAction> as_;

    std::string action_name_;
    // messages for the action
    remy::FibonacciFeedback feedback_;
    remy::FibonacciResult result_;
 ...
 public:
    ...
    void executeCB(const remy::FibonacciGoalConstPtr &goal) {
        ros::Rate r(1);
        bool success = true;
